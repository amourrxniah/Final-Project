    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.paragraph}>
          MoodSync is designed with your privacy in mind. We only collect the
          minimal data necessary to provide personalised activity
          recommendations. Please review our data policy.
        </Text>
        ...
        <Text style={styles.paragraph}>
          Your energy level, mood states, time of day and local weather
          conditions.
        </Text>
        ...
        <Text style={styles.paragraph}>
          Your ratings and completion status to improve recommendation accuracy
          over time.
        </Text>

        <Text style={styles.sectionTitle}>How We Use It</Text>
        <Text style={styles.bullet}>
          • To generate personalised activity recommendations
        </Text>
        <Text style={styles.bullet}>
          • To improve the AI model based on user feedback
        </Text>
        ...
        {[
          [
            "local",
            "All mood and activity is stored locally and encrypted on your device",
          ],
          [
            "anonymous",
            "Your ratings are used anonymously to improve recommendations",
          ],
        ...
        <Text style={[styles.paragraph, styles.sectionParagraph]}>
          The aim of MoodSync is to match users to activity suggestions that
          align with your current mood and context (time of day, weather). This
          aims to reduce decision fatigue and improve your wellbeing.
        </Text>

        {/* NOTICE */}
        <Text style={styles.sectionTitle}>Important Notice</Text>
        <Text style={[styles.paragraph, styles.sectionParagraph]}>
          MoodSync is not designed for mental health diagnosis or crisis
          intervention. If you are experiencing mental health difficulties,
        ...
        <Text style={styles.footerText}>
          By accepting, you agree to our data handling practices as described
          above.
        </Text>
      </ScrollView>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalText}>
              MoodSync requires your consent to store mood and activity data
              locally in order to provide personalised recommendations. Without
              this consent, we cannot offer our services.
            </Text>
